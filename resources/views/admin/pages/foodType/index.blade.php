...
<div class="overflow-x-auto mt-12">
    ...
    <div class="flex gap-2 items-center mb-4">
        <x-primary-button class="justify-center space-x-2 px-2 py-2 rounded-md text-white">
            <a href="{{ route('admin.food-type.create') }}" class="flex items-center space-x-1">
        ...
        <x-edit-button class="bg-yellow-500 hover:bg-yellow-600 flex items-center justify-center space-x-2 px-4 py-2 rounded-md text-white">
            <a href="{{ route('admin.type-export') }}" class="flex items-center space-x-1">
        ...
        <form action="{{ route('admin.type-import') }}" method="POST" enctype="multipart/form-data" class="flex items-center space-x-4">
            @csrf
